...
public class MyLinkedList<E> extends MyAbstractList<E> {
  ...
  /**
   * Removes the list of elements from start index to end index
   * from the list and returns a new linked list 
   * consisting of just these elements */
  public MyLinkedList<E> extractSublist(int start, int end){
    ...
    if (start > end)
      ...
      for (int j = start; j <= end; j++){
        subList.add(counter,remove(start));
        counter++;
      }
    }
    return subList;
  ...
  /**
   * Adds the list prefix to the front of the existing list */
